            ...
            <div className='flex flex-col justify-center items-center h-screen'>
                <div className=' flex justify-center  px-20 items-center backdrop-blur w-0.8 py-4'>
                    ...
                    <div className='flex flex-col px-1 mx-5 divide-black '>
                        <h5 className='font-extralight text-4xl  sm:text-[40px] md:text-[85px] md:leading-[79px] lg:text-[100px] lg:leading-[100px] py-2 dark:text-amber-100'>Page Not Found</h5>
                        <h6 className='hidden sm:flex md:flex font-light text-2xs sm:text-2xs  py-10 md:text-[25px] md:leading-[37px] lg:text-[30px] lg:leading-[50px] dark:text-amber-100 '>You might've taken a wrong step or I forgot to push a commit.🌝🌝</h6>
                </div>
                </div>
